                ...
                <div class="loginbox">
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <p class="account-subtitle">Digite sua nova senha abaixo.</p>
                            ...
                            <form action="{{ route('password.update') }}" method="POST">
                                ...
                                <div class="form-group form-focus {{ $errors->has('email') ? 'is-invalid' : '' }}">
                                    <input type="email" name="email" class="form-control floating" value="{{ old('email', $email ?? '') }}" autocomplete="email" autofocus>
                                ...
                                <div class="form-group form-focus">
                                    ...
                                    <label class="focus-label">Confirmar Nova Senha</label>
                                </div>
